...
void 
LevelSetStopAndGoFilter<TInputImage,TOutputImage>::Start()
{
...
template <class TInputImage, class TOutputImage>
void 
LevelSetStopAndGoFilter<TInputImage,TOutputImage>::Run(unsigned int nIterations) 
{
...
template <class TInputImage, class TOutputImage>
void 
LevelSetStopAndGoFilter<TInputImage,TOutputImage>::GenerateData()
{
  if ( !m_Started)
    Start();
}
...
template <class TInputImage, class TOutputImage>
LevelSetStopAndGoFilter<TInputImage,TOutputImage>::LevelSetStopAndGoFilter()
{
  m_Started = false;
}
...
template <class TInputImage, class TOutputImage>
void 
LevelSetStopAndGoFilter<TInputImage,TOutputImage>::PrintSelf( std::ostream &os, 
