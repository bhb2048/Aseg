//
//  SegLevelSetFunction.h
//  
//  22-dec-11  bhb  From ItkSnap SNAPLevelSetFunction.h
//  Modified:
//
#ifndef __SegLevelSetFunction_h_
#define __SegLevelSetFunction_h_
...
#include "SegAdvectionFieldImageFilter.h"

/**
  class SegLevelSetFunction
  A level set function that implements the generic level set equation
...
class ITK_EXPORT SegLevelSetFunction
  : public itk::SegmentationLevelSetFunction<TImageType>
{
public:
  /** Standard class typedefs. */
  typedef SegLevelSetFunction Self;
  ...
  itkTypeMacro( SegLevelSetFunction, itk::LevelSetFunction );
...
private:
  ...
  typedef SegAdvectionFieldImageFilter<TImageType,float> AdvectionFilterType;
  ...
  itk::Functor::VectorCast< 
    typename VectorInterpolatorType::OutputType,
    VectorType > m_VectorCast;
};

#include "SegLevelSetFunction.txx"
